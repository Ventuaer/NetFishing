...
public class TalkingScript : MonoBehaviour
{
    ...
    void Start()
    {
        UnityEngine.N3DS.Keyboard.SetType(N3dsKeyboardType.Full);
    }

    void Update()
    {
        // Update the textbox text dynamically with the user's input
        if (userTextbox != null)
        {
            userTextbox.text = inputString;
        }
    }
    ...
    void OnGUI()
    {
        ...
        chatLog.AddMessage(inputString);
    ...
    private bool topScreenDims = true;
